...
function PortfolioPage() {
  ...
  const topProjects = [...repos].sort((a, b) => (b.stars || 0) - (a.stars || 0)).slice(0, 6);
      ...
      <main className="relative max-w-2xl mx-auto px-5 mt-8">
        ...
        <div className="flex items-start gap-5 mb-2">
          ...
          <div className="flex-1 pt-1">
            <h1 className="text-2xl font-semibold tracking-tight leading-tight">{user.name}</h1>
        ...
        {topProjects.length > 0 && (
          <div className="mb-10">
            <h2 className={`text-xs font-semibold uppercase tracking-widest mb-4 ${mutedText}`}>
              Selected Work
            </h2>
